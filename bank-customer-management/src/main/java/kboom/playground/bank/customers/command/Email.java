...
public @interface Email {
    ...
    class EmailValidator implements ConstraintValidator<Email, String> {
        ...
        private kboom.playground.bank.customers.domain.model.Email.EmailSpecification emailSpecification = new kboom.playground.bank.customers.domain.model.Email.EmailSpecification();
